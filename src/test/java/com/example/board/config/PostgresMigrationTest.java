...
class PostgresMigrationTest {
    ...
    /** V1 init ~ V29 hot-path indexes. 공통 27개 + PostgreSQL 전용 V11·V28 */
    private static final int EXPECTED_MIGRATIONS = 29;
    ...
    @Test
    @DisplayName("V1~V29 가 PostgreSQL 에서 모두 실행된다 - 문법 호환의 첫 관문")
